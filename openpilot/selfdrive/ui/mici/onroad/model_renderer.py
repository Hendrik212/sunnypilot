...
class ModelRenderer(Widget, ModelRendererSP):
  ...
  def _render(self, rect: rl.Rectangle):
    ...
    if ui_state.radar_tracks and sm.valid['radarTracks'] and sm.recv_frame['radarTracks'] >= ui_state.started_frame:
      self.radar_tracks.draw_radar_tracks(sm['radarTracks'], self._map_to_screen, self._path_offset_z, track_size=3)
